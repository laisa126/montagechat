...
export const HomeTab = ({ 
  ...
  const handleDoubleTapLike = (postId: string, isLiked: boolean) => {
    if (!isLiked) {
      trigger('medium');
      onLike(postId);
    }
  ...
  return (
    <div className="flex flex-col h-full animate-fade-in">
      ...
      {pullDistance > 0 && (
        <div 
          className="flex items-center justify-center bg-background transition-all overflow-hidden"
        ...
        >
          <RefreshCw 
            className={cn(
              ...
              isRefreshing && "animate-spin-refresh"
            )}
            style={{ 
            ...
            {posts.length === 0 ? (
              ...
              posts.map((post, index) => (
                ...
                >
                  ...
                  <DoubleTapHeart 
                    onDoubleTap={() => handleDoubleTapLike(post.id, post.isLiked)}
